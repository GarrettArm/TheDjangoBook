...
class SpreadsheetView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        description = [
            """This page was a successful experiment.  I had been responsible for running a script for a coworker each semester, and could not install python on her computer so that she could run the script herself.  To streamline the process, and make the functionality accessible, I folded the script into a webapp.""",
